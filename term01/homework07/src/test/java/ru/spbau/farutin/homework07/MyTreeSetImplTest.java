...
public class MyTreeSetImplTest {
    ...
    public void testIteratorEmpty() {
        Iterator<Integer> it = new MyTreeSetImpl<Integer>().iterator();
    ...
    public void testIteratorRemove() {
        new MyTreeSetImpl<Integer>().iterator().remove();
    }
    ...
    public void testSizeEmpty() {
        assertEquals("set should be empty", 0, new MyTreeSetImpl<Integer>().size());
    }
